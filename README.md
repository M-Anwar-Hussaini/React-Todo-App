...
**[React-Todo-App]** is a simple React-based project that has the ability to add  and show your daily activites and tasks on a listed order   using the modern web technologies.
...
1. Download or clone this [repostory](https://github.com/M-Anwar-Hussaini/React-Todo-App).
...
- Clone this [repository](https://github.com/M-Anwar-Hussaini/React-Todo-App) to your desired folder:

- Example commands:

```sh
  cd [YOUR FOLDER]
  git clone https://github.com/M-Anwar-Hussaini/React-Todo-App.git
```
...
Feel free to check the [issues page](https://github.com/M-Anwar-Hussaini/React-Todo-App/issues).
...
If you like this project, kindly drop a start for the [repository](https://github.com/M-Anwar-Hussaini/React-Todo-App);
